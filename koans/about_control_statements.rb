...
class AboutControlStatements < EdgeCase::Koan
  ...
  def test_if_statements_with_no_else_with_false_condition_return_value
    ...
    assert_equal nil, value #value is never init, by default all non init are nil
  end

  def test_condition_operators
    assert_equal :true_value, (true ? :true_value : :false_value)
    assert_equal :false_value, (false ? :true_value : :false_value)
    # tricky part assert_equal "bus", ("car" ? "bus" : "car") # string is always true
  end
  ...
  def test_while_statement
    ...
    # 9 40320
    # 10 362880
    # 11 3628800 # exit trigger when i=11
  end
