...
class AboutTrueAndFalse < EdgeCase::Koan
  ...
  def test_everything_else_is_treated_as_true
    assert_equal :true_stuff, truth_value(1) # integers are true
    assert_equal :true_stuff, truth_value(0)
    assert_equal :true_stuff, truth_value([]) # arrays are true
    assert_equal :true_stuff, truth_value({}) # hashes are true
    assert_equal :true_stuff, truth_value("Strings") #strings are true
